...
/* Custom widgets */
require_once( get_template_directory() . '/framework/widgets/recent_posts_widget.php' );
require_once( get_template_directory() . '/framework/widgets/social_links_widget.php' );
require_once( get_template_directory() . '/framework/widgets/most_commented_widget.php' );
require_once( get_template_directory() . '/framework/widgets/most_liked_widget.php' );
require_once( get_template_directory() . '/framework/widgets/authors_widget.php' );
require_once( get_template_directory() . '/framework/widgets/post_format_widget.php' );
