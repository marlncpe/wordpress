    ...
    jQuery('.blox_portfolio').each(function(){
        ...
        .click(function(){
            ...
            },
            {
                ...
                {
                    value: 'masonry2',
                    label: '1. Masonry 2 columns'
                },
                {
                    value: 'masonry3',
                    label: '2. Masonry 3 columns'
                },
                {
                    value: 'masonry4',
                    label: '3. Masonry 4 columns'
                },
                {
                    value: 'centered',
                    label: '4. Centered one column'
                },
                {
                    value: 'grid2',
                    label: '5. Grid 2 columns'
                },
                {
                    value: 'grid3',
                    label: '6. Grid 3 columns'
                },
                {
                    value: 'grid4',
                    label: '7. Grid 4 columns'
                }
                ]
            },
            {
            ...
            },
            {
                ...
                {
                    value: 'both',
                    label: 'Permalink & Lightbox buttons'
                }
                ]
