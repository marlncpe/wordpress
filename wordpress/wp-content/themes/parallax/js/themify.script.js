	...
	(function($, window, document, undefined) {
		...
		Plugin.prototype = {
			...
			init : function() {
				...
				this.updateSecPosition(self.sections);
				$(window).resize(function(){
					self.updateSecPosition(self.sections);
				});
	...
	$(document).ready(function() {
		...
		if( typeof $.fn.easyPieChart !== 'undefined' ) {
			$charts.each(function(){
				...
				if( typeof $.waypoints !== 'undefined' && themifyScript.scrollingEffect == 'enabled' && !is_touch_device() ) {
		...
		// Skillset Animation
		/////////////////////////////////////////////
		if( typeof skrollr !== 'undefined' && themifyScript.scrollingEffect == 'enabled' ) {
