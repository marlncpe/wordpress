...
function themify_theme_enqueue_scripts(){
	...
	if($page_id != null) {
		$slider_play = (get_post_meta( $page_id, 'background_auto', true )) ? get_post_meta( $page_id, 'background_auto', true ) : (!themify_get('setting-footer_slider_auto'))? 'yes' : themify_get('setting-footer_slider_auto');
		$slider_autoplay = (get_post_meta( $page_id, 'background_autotimeout', true )) ? get_post_meta( $page_id, 'background_autotimeout', true ) : (!themify_get('setting-footer_slider_autotimeout'))? 5 : themify_get('setting-footer_slider_autotimeout');
		$slider_speed = (get_post_meta( $page_id, 'background_speed', true )) ? get_post_meta( $page_id, 'background_speed', true ) : (!themify_get('setting-footer_slider_speed'))? 500 : themify_get('setting-footer_slider_speed');
