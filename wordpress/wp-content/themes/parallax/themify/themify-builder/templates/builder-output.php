...
<div id="themify_builder_content-<?php echo $builder_id; ?>" data-postid="<?php echo $builder_id; ?>" class="themify_builder_content themify_builder_content-<?php echo $builder_id; ?> themify_builder themify_builder_front">
	...
	if ( isset( $row['styling']['custom_css_row'] ) ) array_push( $row_classes, $row['styling']['custom_css_row'] ); // Additional Custom css class
	if ( isset( $row['styling']['background_repeat'] ) ) array_push( $row_classes, $row['styling']['background_repeat'] ); // Background repeat class
	if ( isset( $row['styling']['animation_effect'] ) ) array_push( $row_classes, $row['styling']['animation_effect'] ); // Animation Effect
	if ( isset( $row['styling']['row_width'] ) ) array_push( $row_classes, $row['styling']['row_width'] ); // Row Width
	?>
