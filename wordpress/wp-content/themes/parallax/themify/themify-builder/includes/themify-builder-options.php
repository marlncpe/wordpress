...
if ( !is_user_logged_in() || !current_user_can('edit_posts') )
	...
	<div class="lightbox_inner">
		...
		<ul class="themify_builder_options_tab clearfix">
			<li><a href="#themify_builder_options_setting"><?php echo ucfirst( $module_name ); ?></a></li>
			<?php if( isset( $this->modules[ $module_name ]['styling'] ) ): ?>
		...
		<div id="themify_builder_options_setting" class="themify_builder_options_tab_content">
			<?php if( isset( $this->modules[ $module_name ]['options'] ) ) {
				themify_builder_module_settings_field( $this->modules[ $module_name ]['options'], $module_name );
			} ?>
		</div>
		...
		<div id="themify_builder_options_styling" class="themify_builder_options_tab_content">
			<?php
			foreach( $this->modules[ $module_name ]['styling'] as $styling ): ?>
			<?php
