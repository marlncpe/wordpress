...
class Themify_Social_Links extends WP_Widget {
	...
	function Themify_Social_Links() {
		...
		add_action( 'wp_enqueue_scripts', array($this, 'register_font_icons') );
	}

	function register_font_icons() {
		wp_register_style( 'themify-icon-font', THEMIFY_URI . '/fontawesome/css/font-awesome.min.css', array(), THEMIFY_VERSION );
	}
	...
	function widget( $args, $instance ) {
		...
		if ( is_array( $field_ids ) || is_object( $field_ids ) ) {
			...
			if ( 'font-icon' == $icon_type ) {
				wp_enqueue_style( 'themify-icon-font' );
			}
